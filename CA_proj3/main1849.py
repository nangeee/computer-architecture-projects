        ...
        if encoding_format == "R":
            ...
            if bin_str[-7:] == "1100111": # jalr
                ...
                if pc > 16383 or pc < 0:
                    print("Memory address error")
                    pc = ra
                elif pc not in inst_memory.keys():
            ...
            if pc > 0 and pc < 16383 and pc in inst_memory.keys():
                ...
                #regis[rd] = temp
                if tail_branch != 0: # if this is not a tail function 
                    pc = ra
                    #print("pc after jal:", pc)
                    regis[rd] = pc * 4
...
if executed < inst_exc_num:
    print("unknown instructions: outside")
